...
class Card extends Component {
  ...
  // TMDB_KEY = 25cf167dc9b3a3194a8b86fe5968fe13

  // componentWillMount = () => {
  //   const MOVIE_ID = this.props.match.params.id

  //   searchMovies(MOVIE_ID)
    ...
    if (this.props.authenticated) {
      return this.state.favorited ? (
        <svg
          ...
          className='movie__action action__favorite is-true'
          viewBox='0 0 13 12'
    ...
    if (this.props.authenticated) {
      return this.state.toWatchLater ? (
        <svg
          ...
          className='movie__action action__watchlater is-true'
          viewBox='0 0 15 15'
          xmlns='http://www.w3.org/2000/svg'>
  ...
  render() {
    ...
    const movieBackdropStyles = {
      backgroundImage: `url(https://image.tmdb.org/t/p/w1000${
        movie.backdrop_path
      })`,
    ...
    return (
      <div className='Movie-wrapper'>
        <div className='movie-backdrop' style={movieBackdropStyles} />
